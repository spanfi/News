...
public class MainNewsActivity extends AppCompatActivity
    ...
    private static final String LOG_TAG = MainNewsActivity.class.getName();

    /**
     * URL for news data from the GUARDIAN dataset
     */
    private static final String GUARDIAN_REQUEST_URL =
            //"https://content.guardianapis.com/search?q=Clinton%20AND%20Hillary&show-tags=contributor&order-by=newest&api-key=test";
    ...
    public void onLoadFinished(Loader<List<News>> loader, List<News> news) {
        ProgressBar pBar = findViewById(R.id.loading_indicator);
